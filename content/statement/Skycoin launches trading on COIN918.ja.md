...
COIN918への上場は、Skycoinの規模を拡大しようとする試みの最新のものです。暗号通貨の世界でSkycoinが主流となるのは時間の問題でしょう。
...
Skycoinは非常に処理速度が早く、送金は数秒で、ブロックサイズに限度はありません。完全な匿名性を実現し、ネットワーク攻撃への耐性を備えた、安全性の高い通貨です。電力消費量の高い特別なマイニング機器なども必要なく、環境に優しい設計になっています。また、企業の干渉やネットワーク操作から自由なP2Pのインターネットである、Skywireの通貨としてもSkycoinは使われる予定です。 
