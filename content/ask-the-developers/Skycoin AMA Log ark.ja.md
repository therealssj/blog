...
**tranzer**
synthさん、流通していないコインはコールドウォレットに保管してあるのですか？coinmarketcap.comによると、全供給量の小さな部分しか流通していません。Skycoinの特異的な機能はなんでしょうか？
...
プライバシーの問題にも取り組んでいます。パケットが１０の中継地点を通って転送されるとしたら、それぞれの中継地点は直前と直後のノードの情報しか得られません。IPv4のように各パケットが出発点と到着点の情報を持つようなことはありません。このプライバシーのレベルは、現在のインターネットでは不可能です。
...
100の異なるアドレスに、１００万個のコインがそれぞれ保管されています。定期的にロックアップが解かれ、段階的にコインの流通量が増えることになっています。
...
**samuelvihollandia**
SkycoinがVPN接続のために使われると話されていましたが、これが最も大きなSkycoinの実用化のケースでしょうか？
